...
var LoginPage = (function () {
    ...
    LoginPage.prototype.logIn = function (username, password) {
        ...
        if (username.value.length == 0) {
            ...
            this.httpService.postData({
                ...
                var result = res.status; //通过返回的JSON对象的status属性值与0进行比较，相等则登录成功
                if (result == 0) {
    ...
    LoginPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ToastController */]])
    ], LoginPage);
    return LoginPage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__addreport_addreport__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var VisitlistPage = (function () {
    ...
    VisitlistPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* ToastController */]])
    ], VisitlistPage);
...
var CustomermanagerprodetailPage = (function () {
    ...
    CustomermanagerprodetailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__["a" /* HttpService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__visidetail_visidetail__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__otherdetailpage_otherdetailpage__ = __webpack_require__(222);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addotherpage_addotherpage__ = __webpack_require__(108);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__addplanpage_addplanpage__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__addreport_addreport__ = __webpack_require__(55);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AboutPage = (function () {
    function AboutPage(platform, actionsheetCtrl, navCtrl, navParams, httpService, modalCtrl) {
        ...
        */
        ...
        this.hasEvent = '';
        /**
         *点击获取某一天的走访事件，根据hasEvent属性值决定是否向后台发请求,
         *然后判断后台返回数据是否为该天的走访事件，如果是就显示出来
         **/
    ...
    AboutPage.prototype.gotoOtherDetail = function (item) {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_4__otherdetailpage_otherdetailpage__["a" /* OtherDetailPage */], {
            detail: item
        }, { animate: true });
    };
    //设置单选列表状态
    ...
    AboutPage.prototype.gotoMeetingdetil = function (data) {
        console.log(data);
    };
    AboutPage.prototype.gotoCardDetail = function (data) {
        console.log(data);
    };
    //点击全部按钮 进行筛选
    ...
    AboutPage.prototype.ionViewDidLoad = function (data) {
        this.initData(data);
    };
    /*
    * 通过今天获得这周的周一和周日，
    ...
    */
    ...
    AboutPage.prototype.presentModal = function () {
        /* let myModal = this.modalCtrl.create(AddOtherPage,{type:"新增其他任务",num:this.elseList.length});
         ...
         myModal.present();*/
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__addotherpage_addotherpage__["a" /* AddOtherPage */], {}, { animate: true });
    };
    //日历中日程跳转到当前日程的详情
    ...
    AboutPage.prototype.goAddReport = function (datas) {
        var reportModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_7__addreport_addreport__["a" /* addreportPage */], { type: "编辑其它", "showPromp": false, "isAdd": 1, "datas": datas });
    ...
    AboutPage.prototype.go_visidetail = function (item) {
        ...
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_3__visidetail_visidetail__["a" /* VisidetailPage */], { "index": this.status, "item": this.interviewId }, { animate: true });
    };
    //************走访报告*************
    ...
    AboutPage.prototype.plan = function () {
        ...
        var planModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_6__addplanpage_addplanpage__["a" /* AddplanpagePage */], { type: "编辑其它" });
    ...
    AboutPage.prototype.report = function (isAdd) {
        var reportModal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_7__addreport_addreport__["a" /* addreportPage */], { type: "编辑其它", "showPromp": true, "isAdd": isAdd });
        reportModal.onDidDismiss(function (data) {
            //	 this.otherDetails=data;
        });
        reportModal.present();
...
var VisidetailPage = (function () {
    ...
    VisidetailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* ViewController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__["a" /* HttpService */]])
    ], VisidetailPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__addattend_addattend__ = __webpack_require__(221);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_angular_3_9_2_ionic_angular_components_toast_toast_controller__ = __webpack_require__(101);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__addotherpage_addotherpage__ = __webpack_require__(108);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FormalparticularsPage = (function () {
    ...
    FormalparticularsPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_4__providers_HttpService__["a" /* HttpService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__examinerecord_examinerecord__ = __webpack_require__(109);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_Constants__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__potentialcustedit_potentialcustedit__ = __webpack_require__(110);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__potentialcustedit_potentialcustedit__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_Constants__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_HttpService__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__customer_customer__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__project_project__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__rate_rate__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__accountSearch_accountSearch__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__balance_balance__ = __webpack_require__(116);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__customermanagerprodetail_customermanagerprodetail__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__approvedpending_approvedpending__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__businessreport_businessreport__ = __webpack_require__(246);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__approvedpenddetail_approvedpenddetail__ = __webpack_require__(117);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__businessreportdetail_businessreportdetail__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__visitlist_visitlist__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__addreport_addreport__ = __webpack_require__(55);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__customer_customer__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__project_project__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__rate_rate__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__accountSearch_accountSearch__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__balance_balance__ = __webpack_require__(116);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__approvedpending_approvedpending__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__ = __webpack_require__(5);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ApproveprojectdetailPage = (function () {
    ...
    ApproveprojectdetailPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__["a" /* HttpService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__businessreportdetail_businessreportdetail__ = __webpack_require__(118);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CustomermanagerPage = (function () {
    ...
    CustomermanagerPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_0__angular_core__["j" /* ChangeDetectorRef */]])
    ], CustomermanagerPage);
...
var CustomermanagerlistPage = (function () {
    ...
    CustomermanagerlistPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_3__providers_HttpService__["a" /* HttpService */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_potentialcustedit_potentialcustedit__ = __webpack_require__(110);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_otherdetailpage_otherdetailpage__ = __webpack_require__(222);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__pages_addotherpage_addotherpage__ = __webpack_require__(108);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__angular_platform_browser_animations__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__pages_addmeetinginfo_addmeetinginfo__ = __webpack_require__(477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__pages_visit_visit__ = __webpack_require__(478);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__pages_customerlist_customerlist__ = __webpack_require__(379);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__pages_reception_reception__ = __webpack_require__(479);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__pages_report_report__ = __webpack_require__(480);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__components_calendar_calendar_module__ = __webpack_require__(481);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__pages_enjoycard_enjoycard__ = __webpack_require__(227);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__pages_examinerecord_examinerecord__ = __webpack_require__(109);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__pages_opinionfedb_opinionfedb__ = __webpack_require__(483);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__pages_funddailyreport_funddailyreport__ = __webpack_require__(484);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__pages_branchlinereport_branchlinereport__ = __webpack_require__(485);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47__pages_largechangereport_largechangereport__ = __webpack_require__(486);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_48__pages_approvedpending_approvedpending__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_49__pages_approvedpenddetail_approvedpenddetail__ = __webpack_require__(117);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_52__pages_customer_customer__ = __webpack_require__(111);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_53__pages_customerdetail_customerdetail__ = __webpack_require__(237);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54__pages_project_project__ = __webpack_require__(113);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_55__pages_projectDetail_projectDetail__ = __webpack_require__(238);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_56__pages_rate_rate__ = __webpack_require__(114);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_57__pages_rateDetail_rateDetail__ = __webpack_require__(239);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_58__pages_accountSearch_accountSearch__ = __webpack_require__(115);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_59__pages_accountDetail_accountDetail__ = __webpack_require__(240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_60__pages_balance_balance__ = __webpack_require__(116);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_61__pages_balanceDetail_balanceDetail__ = __webpack_require__(241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_62__pages_businessreportdetail_businessreportdetail__ = __webpack_require__(118);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_66__pages_addplanpage_addplanpage__ = __webpack_require__(223);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_67__pages_addreport_addreport__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_71__pages_customermanagerprodetail_customermanagerprodetail__ = __webpack_require__(112);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_72__pages_visitlist_visitlist__ = __webpack_require__(107);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_73__pages_visidetail_visidetail__ = __webpack_require__(219);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_74__pages_prompt_prompt__ = __webpack_require__(487);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_75__pages_attendees_attendees__ = __webpack_require__(220);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_76__pages_addattend_addattend__ = __webpack_require__(221);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__approvedpenddetail_approvedpenddetail__ = __webpack_require__(117);
...
var ApprovedpendingPage = (function () {
    ...
    ApprovedpendingPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_6__providers_HttpService__["a" /* HttpService */]])
    ], ApprovedpendingPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_camera__ = __webpack_require__(470);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_image_picker__ = __webpack_require__(471);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_file__ = __webpack_require__(472);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var CameraPage = (function () {
    function CameraPage(navCtrl, file, imagePicker, loadingCtrl, navParams, camera) {
        this.navCtrl = navCtrl;
        this.file = file;
...
var AddmeetinginfoPage = (function () {
    ...
    AddmeetinginfoPage = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__["a" /* HttpService */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */]])
    ], AddmeetinginfoPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__calendar__ = __webpack_require__(482);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_HttpService__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__attendees_attendees__ = __webpack_require__(220);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var addreportPage = (function () {
    ...
    addreportPage.prototype.presentActionSheet = function () {
        var _this = this;
        var actionSheet = this.actionSheetCtrl.create({
            title: '上传照片',
            cssClass: 'headChoice',
    ...
    addreportPage.prototype.openFile = function () {
        var $this = this;
        XuntongJSBridge.call('selectPic', { 'type': 'photo' }, function (result) {
            var success = String(result.success);
            if (success == "true") {
                var imgdata = "data:image/" + result.data.fileExt + ":base64," + result.data.fileData;
                $this.imgUrl.push(imgdata);
    ...
    addreportPage.prototype.fadeOOut = function ($event) {
        //$event.target.style="display:none";
        $event.target.parentNode.style = "display:none";
        this.num++;
        if (this.imgUrl.length == this.num) {
            this.isAttend = "none";
        ...
        AattendeesModal.onDidDismiss(function (data) {
            ...
            if (_this.dataArr && _this.dataArr.length > 0) {
                if (_this.isDisplayAttend === "none") {
                    _this.attends = _this.dataArr;
                    _this.isDisplayAttend = "block";
                    //data=[];
                }
                else {
                    _this.isDisplayAttend = "none";
                    _this.attends = Array.from(new Set(_this.attends.concat(_this.dataArr)));
